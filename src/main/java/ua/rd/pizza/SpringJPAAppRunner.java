...
public class SpringJPAAppRunner {
    public static void main(String[] args) {
        ...
        customer.setAddress(new Address(null,"Kiev","Umanskaya","2b","22"));
        customer.setLoyaltyCard(new LoyaltyCard(new BigDecimal("0.00")));


        Order newOrder=new Order();
        newOrder.setCustomer(customer);
        newOrder.getCart().addPizza(pizza,2);
